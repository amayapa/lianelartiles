      ...
      >
        ...
        >
          <g id="in">
            <path
              id="Vector"
              d="M51.5625 0.359371H4.4375C3.36827 0.348489 2.33838 0.762219 1.57384 1.50978C0.809287 2.25734 0.372521 3.27766 0.359375 4.34687V51.6622C0.374898 52.7298 0.812709 53.7478 1.577 54.4934C2.34129 55.239 3.36982 55.6515 4.4375 55.6406H51.5625C52.6318 55.6491 53.661 55.234 54.4251 54.4859C55.1893 53.7379 55.6263 52.7178 55.6406 51.6486V4.33328C55.6216 3.2672 55.1825 2.25174 54.4188 1.50762C53.6552 0.763488 52.6287 0.350842 51.5625 0.359371V0.359371Z"
              fill={darkMode ? "white" : "#201E1E"}
            />
            <path
              id="Vector_2"
              d="M8.54282 21.0808H16.7489V47.4844H8.54282V21.0808ZM12.6481 7.94016C13.5893 7.94016 14.5094 8.21931 15.2919 8.74231C16.0744 9.2653 16.6842 10.0086 17.0442 10.8783C17.4042 11.7479 17.4981 12.7048 17.3142 13.6278C17.1302 14.5509 16.6767 15.3986 16.0108 16.0639C15.345 16.7291 14.4968 17.1818 13.5736 17.3649C12.6503 17.548 11.6936 17.4531 10.8243 17.0923C9.95496 16.7315 9.2122 16.121 8.68995 15.338C8.1677 14.555 7.88943 13.6346 7.89032 12.6934C7.89152 11.4324 8.39332 10.2234 9.28545 9.33208C10.1776 8.4408 11.3871 7.94015 12.6481 7.94016Z"
              fill={darkMode ? "#201E1E" : "white"}
            />
            <path
              id="Vector_3"
              d="M21.8964 21.0808H29.7626V24.7058H29.8714C30.968 22.6305 33.6414 20.4419 37.6334 20.4419C45.9437 20.4237 47.4844 25.893 47.4844 32.9844V47.4844H39.2783V34.6383C39.2783 31.5797 39.2239 27.642 35.0144 27.642C30.8048 27.642 30.0889 30.977 30.0889 34.4389V47.4844H21.8964V21.0808Z"
              fill={darkMode ? "#201E1E" : "white"}
            />
          </g>
        </svg>
